...
interface NodeOverlaysProps {
    ...
    showGoogle: boolean
    setShowGoogle: React.Dispatch<React.SetStateAction<boolean>>
}

const NodeOverlays = ({ showVoid, setShowVoid, setIsChatting, showGoogle, setShowGoogle }: NodeOverlaysProps) => {
            ...
            {showGoogle && (
                <>
                    <div className="fixed left-[25px] top-5 w-[calc(100%-50px)] bottom-[75px] bg-white/98 text-white font-light text-md box-border flex flex-col">
                        ...
                        <div className="flex-1 px-5 pb-5 overflow-auto">
                            <script async src="https://cse.google.com/cse.js?cx=d51c54d71d0544094">
                            </script> 
