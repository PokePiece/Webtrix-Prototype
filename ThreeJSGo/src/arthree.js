...
class ARWorld extends THREE.Object3D {
  constructor(opts) {
    ...
    this.is_daytime = hour > 7 && hour < 20;
  ...
  update() {
    ...
    var delta = (time - (this.prevTime || time)) / 1000;
  ...
  clearSelection() {
    if (this.selection) {
      ...
      this.parent.remove(this.selection.sdf);
      this.selection = null;
    }
  }
  ...
  updateSelection(object) {
    ...
    var intersects = this.touch_raycaster.intersectObjects(this.parent.children);
